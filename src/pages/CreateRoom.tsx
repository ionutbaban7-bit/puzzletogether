      ...
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        {step === 1 ? (
          <div className="space-y-7 animate-fade-up">
            ...
            {isCanvas && (
              <div className="rounded-2xl border border-indigo-200 bg-indigo-50 px-4 py-3 text-sm leading-relaxed text-indigo-900">
                <b><T value={{ ro: "Mod Foaie: board complet liber.", en: "Canvas mode: a fully free board." }} /></b>{" "}
                <T value={{
                  ro: "O foaie albă, fără imagine de referință. Cărțile se pot muta, răsturna, duplica și șterge până le blochează facilitatorul. Finalizarea o declanșează facilitatorul.",
                  en: "A blank white sheet with no reference image. Tiles can be moved, flipped, duplicated and deleted until the facilitator locks the board. The facilitator triggers completion.",
                }} />
              </div>
            )}
